    ...
    <div className="absolute top-0 flex flex-col w-full h-full items-center justify-start">
      <div className="relative w-full">
        ...
        <button
          ...
          }   absolute top-0 h-2 hover:h-3 bg-[#407bff] transition-all duration-75 z-10`}
          style={{
        ...
        <button
          ...
          } lg:hidden absolute top-0 left-0 h-2 hover:h-3 bg-[#407bff] transition-all duration-75 z-10`}
          style={{
